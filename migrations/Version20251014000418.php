 ...
 */
final class Version20251014000418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author1_id INT NOT NULL, ADD title VARCHAR(150) NOT NULL, ADD publication_date DATE NOT NULL, ADD enabled TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP author1_id, DROP title, DROP publication_date, DROP enabled');
    }
}
